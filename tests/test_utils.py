...
def test_create_dict_from_json():
    """
    тест для функции create_dict_from_json - перевод JSON в читаемый для Python список.
    """
    assert create_dict_from_json(PATH) == [{'id': 441945886, 'state': 'EXECUTED', 'date': '2019-08-26T10:50:58.294041',
                                           ...
                                           {'id': 147815167, 'state': 'EXECUTED', 'date': '2018-01-26T15:40:13.413061',
                                            'operationAmount': {'amount': '50870.71',
                                                                'currency': {'name': 'руб.', 'code': 'RUB'}},
                                            'description': 'Перевод с карты на счет',
                                            'from': 'Maestro 4598300720424501', 'to': 'Счет 43597928997568165086'},
                                           ...
                                           {'id': 407169720, 'state': 'EXECUTED', 'date': '2018-02-03T14:52:08.093722',
                                            'operationAmount': {'amount': '67011.26',
                                                                'currency': {'name': 'руб.', 'code': 'RUB'}},
                                            'description': 'Перевод с карты на карту',
                                            'from': 'MasterCard 4047671689373225', 'to': 'Maestro 3806652527413662'},
                                           ...
                                           {'id': 536723678, 'state': 'EXECUTED', 'date': '2018-06-12T07:17:01.311610',
                                            'operationAmount': {'amount': '26334.08',
                                                                'currency': {'name': 'USD', 'code': 'USD'}},
                                            'description': 'Перевод организации',
                                            'from': 'Visa Classic 4195191172583802', 'to': 'Счет 17066032701791012883'},
                                           ...
                                           {'id': 888407131, 'state': 'EXECUTED', 'date': '2019-09-29T14:25:28.588059',
                                            'operationAmount': {'amount': '45849.53',
                                                                'currency': {'name': 'USD', 'code': 'USD'}},
                                            'description': 'Перевод со счета на счет',
                                            'from': 'Счет 35421428450077339637', 'to': 'Счет 46723050671868944961'},
                                           ...
                                           {'id': 811920303, 'state': 'EXECUTED', 'date': '2019-06-14T19:37:49.044089',
                                            'operationAmount': {'amount': '63150.74',
                                                                'currency': {'name': 'USD', 'code': 'USD'}},
                                            'description': 'Перевод со счета на счет',
                                            'from': 'Счет 73222753239048295679', 'to': 'Счет 78544755774551298747'},
                                           ...
                                           {'id': 743278119, 'state': 'EXECUTED', 'date': '2018-10-15T08:05:34.061711',
                                            'operationAmount': {'amount': '51203.12',
                                                                'currency': {'name': 'USD', 'code': 'USD'}},
                                            'description': 'Перевод с карты на карту',
                                            'from': 'MasterCard 1435442169918409', 'to': 'Maestro 7452400219469235'},
                                           ...
                                           {'id': 373912477, 'state': 'EXECUTED', 'date': '2018-03-09T02:11:01.339352',
                                            'operationAmount': {'amount': '33249.01',
                                                                'currency': {'name': 'руб.', 'code': 'RUB'}},
                                            'description': 'Перевод с карты на счет',
                                            'from': 'Visa Classic 7022985698476865', 'to': 'Счет 60979028617970883410'},
                                           ...
                                           {'id': 72122709, 'state': 'EXECUTED', 'date': '2018-12-18T17:07:09.800800',
                                            'operationAmount': {'amount': '19683.25',
                                                                'currency': {'name': 'USD', 'code': 'USD'}},
                                            'description': 'Перевод со счета на счет',
                                            'from': 'Счет 86675623828180311969', 'to': 'Счет 15351391408911677994'},
                                           ...
                                           {'id': 100392079, 'state': 'EXECUTED', 'date': '2019-03-03T03:13:18.622393',
                                            'operationAmount': {'amount': '44493.45',
                                                                'currency': {'name': 'USD', 'code': 'USD'}},
                                            'description': 'Перевод с карты на счет',
                                            'from': 'Visa Classic 6319351940209800', 'to': 'Счет 14073196441261107791'},
                                           ...
                                           {'id': 464419177, 'state': 'CANCELED', 'date': '2018-07-15T18:44:13.346362',
                                            'operationAmount': {'amount': '71024.64',
                                                                'currency': {'name': 'руб.', 'code': 'RUB'}},
                                            'description': 'Перевод с карты на счет',
                                            'from': 'Visa Gold 9657499677062945', 'to': 'Счет 19213886662094884261'},
                                           ...
                                           {'id': 894961746, 'state': 'EXECUTED', 'date': '2019-08-04T20:17:25.443322',
                                            'operationAmount': {'amount': '2523.44',
                                                                'currency': {'name': 'руб.', 'code': 'RUB'}},
                                            'description': 'Перевод со счета на счет',
                                            'from': 'Счет 33721541831646393763', 'to': 'Счет 68774571780974952778'},
                                           ...
                                           {'id': 854048120, 'state': 'EXECUTED', 'date': '2019-03-29T10:57:20.635567',
                                            'operationAmount': {'amount': '30234.99',
                                                                'currency': {'name': 'USD', 'code': 'USD'}},
                                            'description': 'Перевод с карты на счет',
                                            'from': 'Visa Classic 1203921041964079', 'to': 'Счет 34616199494072692721'},
                                           ...
                                           {'id': 692008409, 'state': 'CANCELED', 'date': '2019-02-14T17:38:09.910336',
                                            'operationAmount': {'amount': '37044.95',
                                                                'currency': {'name': 'руб.', 'code': 'RUB'}},
                                            'description': 'Перевод организации',
                                            'from': 'Visa Classic 4610247282706784', 'to': 'Счет 63229171188548882700'},
                                           ...
                                           {'id': 232222017, 'state': 'EXECUTED', 'date': '2018-07-06T22:32:10.495465',
                                            'operationAmount': {'amount': '37160.27',
                                                                'currency': {'name': 'руб.', 'code': 'RUB'}},
                                            'description': 'Перевод с карты на карту',
                                            'from': 'Visa Classic 4062745111784804', 'to': 'Maestro 8602249654751155'},
                                           ...
                                           {'id': 185048835, 'state': 'EXECUTED', 'date': '2019-05-06T00:17:42.736209',
                                            'operationAmount': {'amount': '74895.83',
                                                                'currency': {'name': 'руб.', 'code': 'RUB'}},
                                            'description': 'Перевод со счета на счет',
                                            'from': 'Счет 27921306202254867520', 'to': 'Счет 49884962711830774470'},
                                           ...
                                           {'id': 490100847, 'state': 'EXECUTED', 'date': '2018-12-22T02:02:49.564873',
                                            'operationAmount': {'amount': '56516.63',
                                                                'currency': {'name': 'USD', 'code': 'USD'}},
                                            'description': 'Перевод с карты на карту',
                                            'from': 'Visa Gold 8326537236216459', 'to': 'MasterCard 6783917276771847'},
                                           ...
                                           {'id': 27192367, 'state': 'CANCELED', 'date': '2018-12-24T20:16:18.819037',
                                            'operationAmount': {'amount': '991.49',
                                                                'currency': {'name': 'руб.', 'code': 'RUB'}},
                                            'description': 'Перевод со счета на счет',
                                            'from': 'Счет 71687416928274675290', 'to': 'Счет 87448526688763159781'},
                                           ...
                                           {'id': 957763565, 'state': 'EXECUTED', 'date': '2019-01-05T00:52:30.108534',
                                            'operationAmount': {'amount': '87941.37',
                                                                'currency': {'name': 'руб.', 'code': 'RUB'}},
                                            'description': 'Перевод со счета на счет',
                                            'from': 'Счет 46363668439560358409', 'to': 'Счет 18889008294666828266'},
...
def test_five_last_successful_operations():
    """
    ...
    assert five_last_successful_operations(test_list) == [{'date': '2019-12-08T22:46:21.935582', 'state': 'EXECUTED'},
                                                          {'date': '2018-12-08T22:46:21.935582', 'state': 'EXECUTED'},
                                                          {'date': '2018-03-08T22:46:21.935582', 'state': 'EXECUTED'},
                                                          {'date': '2017-11-08T22:46:21.935582', 'state': 'EXECUTED'},
                                                          {'date': '2017-10-08T22:46:21.935582', 'state': 'EXECUTED'}]